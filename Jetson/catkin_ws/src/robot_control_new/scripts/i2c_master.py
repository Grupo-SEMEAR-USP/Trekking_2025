...
# Constantes
ESP32_ADDRESS = 0x69  # Endereço do dispositivo ESP32 esquerdo no barramento I2C
I2C_BUS = 0  # Número do barramento I2C na Jetson
REG_ADDRESS = 0x00  # Endereço de registro (offset) a ser usado pelo PID
