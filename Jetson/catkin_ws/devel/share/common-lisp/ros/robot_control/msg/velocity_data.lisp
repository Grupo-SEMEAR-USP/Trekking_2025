...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <velocity_data>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'angular_speed_left))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'angular_speed_right))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <velocity_data>) istream)
  "Deserializes a message object of type '<velocity_data>"
    ...
    (cl:setf (cl:slot-value msg 'angular_speed_left) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'angular_speed_right) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<velocity_data>)))
  ...
  "e294170f2d297bc948c772795931b47a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'velocity_data)))
  "Returns md5sum for a message object of type 'velocity_data"
  "e294170f2d297bc948c772795931b47a")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<velocity_data>)))
  ...
  (cl:format cl:nil "# velocity_data.msg~%float32 angular_speed_left~%float32 angular_speed_right~%float32 servo_angle~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'velocity_data)))
  "Returns full string definition for message of type 'velocity_data"
  (cl:format cl:nil "# velocity_data.msg~%float32 angular_speed_left~%float32 angular_speed_right~%float32 servo_angle~%~%"))
