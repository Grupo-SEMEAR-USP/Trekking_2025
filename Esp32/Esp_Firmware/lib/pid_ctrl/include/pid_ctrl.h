...
typedef enum {
    ...
    PID_CAL_TYPE_POSITIONAL_DELTA_TIME, /*!< Positional PID control with time compute */
    PID_CAL_TYPE_POSITIONAL_DEFAULT, /*!< Default Positional PID control */
...
typedef struct pid_ctrl_block_t {
