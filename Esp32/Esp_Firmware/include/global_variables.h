...
extern double global_total_theta;

//extern float global_servo_angle;
extern float global_ros_servo_angle;

extern uint32_t global_timer_miliseconds;
extern uint32_t global_time_stamp_miliseconds;