...
struct rotary_encoder_t {
    ...
    /**
     * @brief Reset rotary encoder counter value
     *
     * @param encoder Rotary encoder handle
     * @return 
     *      - ESP_OK: Reset rotary encoder successfully
     *      - ESP_FAIL: Reset rotary encoder failed because of other error
     */
    esp_err_t (*reset_counter_value)(rotary_encoder_t *encoder);
};
